...
#     male_terms.append(key)
#     female_terms.append(term_dict[key])
#
# print("-->male_terms", male_terms)
# print("-->female_terms", female_terms)
# print(len(male_terms), len(female_terms))

# male_adj = []
# male_noun = []
# for i in range(0, len(female_terms)):
#     f_term = female_terms[i]
#     m_term = male_terms[i]
#     if f_term in female_adj:
#         male_adj.append(m_term)
#     else:
#         male_noun.append(m_term)
#
# print("-->male_adj", male_adj)
# print("-->male_noun", male_noun)
# print(len(male_noun), len(female_noun))
# print(len(male_adj), len(female_adj))

female_adj = []
female_noun = []
for i in range(0, len(female_terms)):
    term = female_terms[i]
    if term in female_adj1:
        female_adj.append(term)
    else:
        female_noun.append(term)
print("-->female_adj", female_adj)
print("-->female_noun", female_noun)
print(len(female_terms))
print(len(female_noun), len(female_adj))
...
print("-->terms_f2m", terms_f2m)
print("-->terms_m2f", terms_m2f)
